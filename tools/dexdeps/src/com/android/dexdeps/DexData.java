...
public class DexData {
     ...
     */
    public void load(boolean includeMoKeeClasses) throws IOException {
        parseHeaderItem();
        ...
        markInternalClasses(includeMoKeeClasses);
    }
     ...
     */
    void markInternalClasses(boolean includeMoKeeClasses) {
        ...
        for (int i = 0; i < mTypeIds.length; i++) {
            ...
            if (includeMoKeeClasses && className.startsWith("Lmokee")) {
